...
$this->title = 'HOME';
$this->registerCssFile ( "@web/assets/HomeCSS/css/swing.css" );
	...
	<body class="demo-3 loading">
		<svg class="hidden">
			...
			<div class="content content--intro">
				<div class="frame">
					<a class="github" href="https://github.com/poon1412/tradefootball" title="Find this project on GitHub"><svg class="icon icon--github"><use xlink:href="#icon-github"></use></svg></a>
				</div>
				<div class="content__inner">
					<h2 class="word word--swing">Linlijian</h2><br><br><br>
					<button id="component-9" class="button button--9" style="filter: url('#filter-ripple-2')"><a href="#" class="enter">enter</a></button>
				</div>
